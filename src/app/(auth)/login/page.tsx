...
export default function LoginPage() {
  ...
  <Card className="my-auto mx-auto w-130 p-12 items-center">
    ...
    <Link
        ...
        <a href="/registracia" className="text-muted-foreground">Nemáš ešte u nás účet? <span className="text-primary underline cursor-pointer hover:text-chart-5">Zaregistruj sa!</span></a>
  </Card>
  </div>
  </div>);
}
