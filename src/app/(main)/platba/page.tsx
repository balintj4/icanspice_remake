    ...
    *****************************************************************/}
        ...
        <div className="mx-8 p-6 px-10 flex flex-col basis-1/3 gap-4 sticky top-24">
          ...
          <Field orientation="horizontal">
            ...
            />
            <FieldContent>
              <FieldLabel>Súhlas s obchodnými podmienkami</FieldLabel>
              <FieldDescription>
                Zaškrtnutím vyhlasujem, že som si obchodné podmienky a podmienky
                spracovania osobných údajov prečítal a súhlasím s nimi v plnom
                rozsahu.
              </FieldDescription>
            </FieldContent>
          </Field>
